...
export const metadata: Metadata = {
  title:
    'Видалення Вм’ятин без Фарбування у Червонограді / Шептицькому | @dent_center_chg',
  description:
    'Видалення вм’ятин без фарбування у Червонограді / Шептицькому; Технологія PDR; Швидко та якісно; Витягування вмятин від граду, ДТП і т.п. без покраски,без шпаклівки та фарбування',
  keywords: [
    'видалення вм’ятин',
    'без фарбування',
    'Червоноград',
    ...
    '@dent_center_chg',
    'ремонт вм’ятин',
    'вирівнювання вмятин Шептицький',
    'видалення граду',
  ...
  openGraph: {
    ...
    description:
      'Якісне видалення вм’ятин без фарбування у Червонограді / Шептицькому. Відновлення авто після граду та ДТП швидко і без покраски.',
